...
//         var serviceData =
//             bookingEditController.bookingDetails?.serviceData ?? [];
//
//         var bookingDetails1 = Get.find<BookingDetailsController>()
//             .bookingDetails
//             ?.bookingContent
//             ?.bookingDetailsContent;
//
//         var sdatalength = bookingDetails1!.serviceData?.length;
//         print('--serv--${bookingDetails1!.serviceData?.length}');
...
//                                       DateTime.tryParse(
//                                           bookingEditController.scheduleTime!)),
//                                   style: robotoRegular.copyWith(
...
//                           TextButton(
//                             onPressed: bookingEditController.cartList.length ==
//                                         1 &&
//                                     bookingEditController
...
//                               Icon(
//                                 Icons.add,
//                                 color: bookingEditController.cartList.length ==
//                                             1 &&
//                                         bookingEditController
//                                                 .cartList[0].variantKey ==
//                                             null
                ...
                child: SafeArea(
                  child: CustomButton(
                    ...
                    onPressed: () {
                      ...
                      // Append only valid new service data
