  ...
  Widget build(BuildContext context) {
    return GetBuilder<BookingDetailsController>(
      ...
      final List<ServiceData> serviceData = bookingDetails.serviceData ?? [];
        ...
        // Object totalCouponDiscountAmount = bookingDetails.totalCouponDiscountAmount ?? 0 ;

        double totalDiscount = (discount + campaignDiscount);
        double subTotal = BookingHelper.getSubTotalCost(bookingDetails);

      // double subTotal = ItemService.serviceCost ?? 0;
      ...
      final double subTotalALL = subTotal + (bookingDetails.extraFee ?? 0) - totalDiscount -totalReferralDiscountAmount ;

      // double subTotalALL = BookingHelper.getSubTotalCost(bookingDetails) +  ${PriceConverter.convertPrice(bookingDetails.extraFee ?? 0, isShowLongPrice: true)} - ${PriceConverter.convertPrice(totalDiscount, isShowLongPrice: true)};
        return Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(children: [
                        ...
                        // Check if the serviceData is not null and has any items
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              "(-) ${PriceConverter.convertPrice(totalReferralDiscountAmount, isShowLongPrice: true)}",
                              style: robotoRegular.copyWith(
                                  fontSize: Dimensions.fontSizeDefault,
                                  color: Theme.of(context)
                                      .textTheme
